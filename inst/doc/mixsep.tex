...
\begin{figure}[!h]
  \centering
  \begin{tabular}{cc}
    \parbox{7.5cm}{\includegraphics[width=7.4cm]{database_query}} &
    \parbox{7.5cm}{\includegraphics[width=7.4cm]{database_query_result}}\\
    Query window. & Result of \textsl{10-18687} query.\\\\
    \parbox{7.5cm}{\includegraphics[width=7.4cm]{database_query_select}} &
    \parbox{7.5cm}{\includegraphics[width=7.4cm]{database_transfer}}\\
